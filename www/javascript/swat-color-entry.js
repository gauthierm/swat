 ...
 */
function SwatColorEntry(id, colors, none_option_title)
{
	SwatColorEntry.superclass.constructor.call(this, id);
...
// }}}
// {{{ YAHOO.lang.extend(SwatColorEntry, SwatAbstractOverlay)
...
init: function()
{
	...
	SwatColorEntry.superclass.init.call(this);
...
getBodyContent: function()
{
	...
	table.className = 'swat-color-entry-table';
	table.cellSpacing = '1';
	...
	if (this.none_option_title !== null) {
		...
		YAHOO.util.Dom.addClass(tcell,
			'swat-color-entry-palette-blank');
...
{
	var toggle_button = SwatColorEntry.superclass.getToggleButton.call(this);
...
getFooter: function()
{
	...
	hex_div.className = 'swat-color-entry-palette-hex-color';
	hex_div.appendChild(label_tag);
	hex_div.appendChild(this.hex_input_tag);

	var footer = SwatColorEntry.superclass.getFooter.call(this);
...
// }}}
// {{{ SwatColorEntry.prototype.handleInputChange

SwatColorEntry.prototype.handleInputChange = function()
{
...
// }}}
// {{{ SwatColorEntry.prototype.setColor
 ...
 */
SwatColorEntry.prototype.setColor = function(color)
{
...
// }}}
// {{{ SwatColorEntry.prototype.selectNull
 ...
 */
SwatColorEntry.prototype.selectNull = function(e)
{
...
// }}}
// {{{ SwatColorEntry.prototype.selectColor
 ...
 * @param Event the event that triggered this select.
 */
SwatColorEntry.prototype.selectColor = function(event)
{
...
// }}}
// {{{ SwatColorEntry.prototype.highlightPaletteEntry
 ...
 * @param number color the hex value of the color
 */
SwatColorEntry.prototype.highlightPaletteEntry = function(color)
{
	if (this.none_option_title !== null) {
		...
		if (color === null) {
			YAHOO.util.Dom.addClass(null_entry,
				'swat-color-entry-palette-selected');
		} else {
