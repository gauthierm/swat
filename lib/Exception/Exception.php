 ...
 * messages. Call Exception::setupHandler() to register Swat's exception as
 * the PHP exception handler. The exception handler is able to handle all
 * sub-classes of exception by internally wrapping non-Swat exceptions in a new
 * instance of a Silverorange\Swat\Exception. This allows all exceptions to be
 * nicely formatted and processed consistently.
 *
 * Custom displaying and logging of exceptions can be achieved through
 * {@link Exception::setLogger()} and {@link Exception::setDisplayer()}.
 *
 * Filtering Sensitive Data out of Stack Traces:
 *
 * By default, Swat displays and logs stack traces that containing all
 ...
 * generated by Swat, add the following documentation tag to the method-level
 * documentation:
 * <code>
 * <?php
 * /**
...
class Exception extends \Exception
{
     ...
     * For example:
     * <code>
     * SwatException::setLogger(new MyLogger());
     * </code>
     *
    ...
    /**
     * Sets the object that displays exception objects when they are processed
     *
     * For example:
     * <code>
     * Exception::setDisplayer(new MyDisplayer());
     * </code>
     *
     * @param Displayer $displayer the object to use to display exceptions.
     */
     ...
     *                      method.
     */
    public static function setupHandler($class = 'Silverorange\Swat\Exception')
    {
     ...
     *
     * @param boolean $exit    optional. Whether or not to exit after
     *                         processing this exception. If unspecified,
     *                         defaults to true.
     ...
     *
     * Wraps a generic exception in a Swat exception object and process the
     * Swat exception object.
     *
     * @param \Exception $e the exception to handle.
     */
    public static function handle(\Exception $e)
    {
        // wrap other exceptions in Swat exceptions
     ...
     *
     * @see Exception::$sensitive_param_names
     */
    ...
    protected function formatValue($value)
    {
        ...
        if (is_object($value)) {
            ...
            if (Util\String::validateUtf8($value)) {
                $formatted_value = "'".$value."'";
            } else {
                $formatted_value = '"'.Util\String::escapeBinary($value).'"';
            }
