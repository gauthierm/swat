...
class SwatDB
{
     ...
     * SwatAction}s that change a single database field.
     *
     * @param MDB2_Driver_Common $db       The database connection.
     ...
     * @throws SwatDBException
     */
    public static function queryOneFromTable($db, $table, $field,
        $id_field = null, $id = 0)
    {
        $field = new SwatDBField($field, 'integer');
     ...
     * @throws SwatDBException
     */
    public static function queryRowFromTable($db, $table, $fields, $id_field,
        $id)
    {
     ...
     * @param MDB2_Driver_Common $db              The database connection.
     * @param string             $table           The database table to query.
     * @param string             $title_field     The name of the database field
     *                                            to query for the title. Can be
     *                                            given in the form type:name
     *                                            where type is a standard MDB2
     *                                            datatype. If type is ommitted,
     *                                            then text is assumed for this
     *                                            field.
     * @param string             $id_field        The name of the database field
     *                                            to query for the id. Can be
     *                                            given in the form type:name
     *                                            where type is a standard MDB2
     *                                            datatype. If type is ommitted,
     *                                            then integer is assumed for
     *                                            this field.
     * @param string             $cascade_field   The name of the database field
     *                                            to cascade the options by. Can
     *                                            be given in the form type:name
     *                                            where type is a standard MDB2
     *                                            data type. If type is
     ...
     *                                              is a standard MDB2 datatype.
     *                                              If type is ommitted, then
     ...
     *                                              conditionals.
     * @param SwatDataTreeNode   $tree              a tree to add nodes to. If
     ...
     *                      given in the form type:name where type is a
     *                      standard MDB2 data type. If type is ommitted, then
     *                      text is assumed.
     *
     ...
     *
     * @param MDB2_Driver_Common $rs                  The MDB2 result set,
     *                                                usually the result of a
     *                                                stored procedure. Must be
     *                                                wrapped in
     ...
     *                                                field representing the id.
     * @param string             $level_field_name    the name of the database
     *                                                field representing the
     *                                                tree level.
     * @param SwatDataTreeNode   $tree                an optional tree to add
     *                                                nodes to. If no tree is
     *                                                specified, nodes are
     *                                                added to a new empty tree.
     *
     * @return SwatDataTreeNode a tree composed of {@link SwatDataTreeNode}
     *                          objects.
     *
