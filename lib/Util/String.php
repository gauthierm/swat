...
class String
{
     ...
     *                            length.
     * @param string  $ellipses   the ellipses characters to append if the
     *                            string is shortened. By default, this is a
     ...
     *                            non-breaking space followed by a unicode
     *                            ellipses character.
     * @param boolean &$flag      an optional boolean flag passed by reference
     *                            to the ellipsize function. If the given
     *                            string is ellipsized, the flag is set to
     *                            true. If no ellipsizing takes place, the flag
     *                            is set to false.
     *
     ...
     * @param string  $ellipses   the ellipses characters to insert if the
     *                            string is shortened. By default, this is a
     *                            unicode ellipses character padded by
     *                            non-breaking spaces.
     * @param boolean &$flag      an optional boolean flag passed by reference
     *                            to the ellipsize function. If the given
     *                            string is ellipsized, the flag is set to
    ...
    public static function ellipsizeMiddle(
        ...
        if ($has_space === false) {
            ...
            $first_piece = self::ellipsizeRight(
                $string,
                $max_first_length,
                ''
            );
     ...
     * @param integer $decimals                 number of decimal places to
     *                                          display. By default, the full
     *                                          number of decimal places of the
     *                                          value will be displayed.
     * @param string  $locale                   an optional locale to use to
     *                                          format the value. If no locale
     ...
     * @param integer $magnitude          optional. The power of 2 to use as
     *                                    the unit base. This value will be
     *                                    rounded to the nearest ten if
     *                                    specified. If less than zero or not
    *                                     specified, the highest power less
     *                                    than <code>$value</code> will be used.
     * @param boolean $iec_units          optional. Whether or not to use IEC
     *                                    binary multiple prefixed units
     *                                    (Mebibyte). Defaults to using
     *                                    canonical units.
     ...
     * @param integer $pad_length length in characters to pad to.
     * @param string  $pad_string string to use for padding.
     * @param integer $pad_type   type of padding to use:
     *                            <code>STR_PAD_LEFT</code>,
