...
class TableViewGroup extends TableViewColumn
{
     ...
     *
     * @param mixed $row      a data-object containing the data for the first
     *                        row in in the table store for this group.
     * @param mixed $row      a data-object containing the data for the current
     *                        row being displayed in the table-view.
