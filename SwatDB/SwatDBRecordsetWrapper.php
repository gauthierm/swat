    ...
    SwatDBMarshallable, SwatDBFlushable
{
     ...
     * @param string $table             the name of the table containing
     *                                  sub-records.
     ...
     *                                  foreign key).
     * @param string $where             optional additional where clause to
     *                                  apply to the sub-records.
     * @param string $order_by optional ordering of sub-recordsets.
     * @param string $fields            optional list of fields to return. By
     *                                  default all fields are returned. This
     *                                  can be used to optimize tables with
