...
class SwatYUIComponent extends SwatObject
{
     ...
     *
     * @param string  $id   the identifier of this YUI component. This
     *                      corresponds to a directory name under the
     *                      <i>build</i> directory in the YUI distribution.
     ...
     * @param string $filename            optional. The filename of the YUI
     *                                    JavaScript for this component. If not
     *                                    specified, the name of the component
     *                                    is used. Do not specify the file
     *                                    extension or the -min/-debug suffix
     *                                    here.
     */
     ...
     *                                     component's id is used.
     * @param string  $filename            optional. The filename of the YUI
     *                                     style-sheet for this component. If
     *                                     not specified, the name of the
     *                                     component is used. Do not specify
     *                                     the file extension or the -min
     *                                     suffix here.
     * @param boolean $has_min_version     optional. Whether or not the
     *                                     style-sheet for this component has a
